...
app.post('/api/tts/synthesize', async (req, res) => {
    try {
        ...
        const GOOGLE_TTS_API_KEY = "AIzaSyCrGozdiMxIyws1G_G0R2OezCbU-o1F56Y";
...
app.listen(PORT, () => {
    ...
    console.log(`📢 Google Cloud TTS API endpoint: http://localhost:${PORT}/api/tts/synthesize`);
    console.log(`🔑 Using API key: AIzaSyCrGozdiMxIyws1G_G0R2OezCbU-o1F56Y`);
});
